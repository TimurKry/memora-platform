...
export default function KartePage() {
  return (
    <>
      <Header />
      <main className="mx-auto max-w-editorial px-8 py-16 lg:px-14 lg:py-20">
        ...
        <p className="editorial-body mt-4 max-w-lg">
          ...
          Angehörige finden — Demo-Ansicht.
        </p>
        <div className="mt-12 border border-memora-border bg-memora-white p-6 lg:p-10">
          <CemeteryMap />
        </div>
      </main>
      <CategoryBar />
