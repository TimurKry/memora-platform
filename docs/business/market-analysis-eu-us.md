...
**Сегмент:** 3–5 пилотных бюро + 1 кладбище-партнёр  

| Квартал | Продукт | GTM | KPI |
|---------|---------|-----|-----|
| Q1 | Case MVP, чек-листы, статусы, web-public лиды | 10–15 встреч с бюро | 1 LOI |
| Q2 | Stripe, family status link, cemetery request | 2 платящих пилота €79–149 | 2 MRR клиента |
| Q3 | Calendar, документы v1, white-label polish | 5 бюро на платформе | 10+ Cases closed |
| Q4 | Референсы, кейс-студия DE | Расширение на Dresden/Chemnitz | **€15–30K ARR** |

**Не делаем:** marketplace, US, gov API, AI, 5 стран.

**North star:** *3 платящих бюро + 15 Cases end-to-end через MEMORA.*
...
|------|-------------|-----------|
| Длинный цикл продаж бюро | Высокая | Пилот 14 дней бесплатно, один город, личные визиты |
...
3. Оффер пилота: **14 дней · Case + сайт · €0**, затем €99/мес
